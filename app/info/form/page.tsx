  ...
  <Form.Root className="w-full" onSubmit={(event) => { onSubmit(event) }}>
    ...
    <Form.Field className="grid mb-[10px]" name="phone">
      <div className="flex items-baseline justify-between">
        ...
        <Form.Message className="text-[13px] text-[rgb(var(--background-senix-orange-rgb))] opacity-[0.8]" match="valueMissing">
          Please enter your phone number
        </Form.Message>
      </div>
      <Form.Control asChild>
    ...
    <Form.Submit asChild>
      <button className="box-border w-full text-white shadow-blackA4 inline-flex h-[35px] items-center justify-center rounded-[4px] bg-[rgb(var(--background-senix-orange-rgb))] px-[15px] font-medium leading-none shadow-[0_2px_10px] mt-[10px]">
        Lucky draw
      </button>
    </Form.Submit>
  </Form.Root>
